...
} satisfies Partial<Record<ProviderMark, string>>
...
export function ProviderIcon(props: { mark: ProviderMark; size?: number; className?: string }) {
  ...
  if (props.mark === 'kimi') {
    return (
      <svg className={props.className} width={size} height={size} viewBox="0 0 24 25" aria-hidden>
        <path
          d="M21.72.94a2.23 2.23 0 0 1 0 4.46h-1.97a.26.26 0 0 1-.26-.26V3.17A2.23 2.23 0 0 1 21.72.94Z"
          fill="#1783ff"
        />
        <path
          d="m9.39 13.95 8.43-8.36c.16-.16.07-.47-.14-.47h-4.54l-.14.06-9.08 9.01c-.14.14-.35.02-.35-.21V5.39c0-.15-.1-.27-.22-.27H.22c-.12 0-.22.12-.22.27v18.53c0 .15.1.27.22.27h3.13c.12 0 .22-.12.22-.27v-3.78c0-.08.03-.16.08-.21l2.82-2.79c.07-.07.16-.08.24-.03l7.53 5.54c1.23.83 2.61 1.34 4.01 1.49.12.01.23-.11.23-.27v-3.56c0-.14-.08-.25-.19-.26-.82-.13-1.63-.45-2.35-.94L9.42 14.39c-.14-.09-.15-.32-.03-.44Z"
          fill="currentColor"
        />
      </svg>
    )
  ...
  if (props.mark === 'pi') {
    // Two subpaths with a window hole: needs evenodd, which the shared
    // single-path renderer below deliberately does not apply.
    return (
      <svg className={props.className} width={size} height={size} viewBox="0 0 24 24" aria-hidden>
        <path
          d="M1 1h16.5v11H12v5.5H6.5V23H1V1zm5.5 5.5V12H12V6.5H6.5z M17.5 12H23v11h-5.5V12z"
          fill="currentColor"
          fillRule="evenodd"
        />
      </svg>
