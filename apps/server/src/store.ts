...
export class Store {
  ...
  usageEvents(): StoredUsageEvent[] {
    // Read the indexed projection, not the event log: usage rows are a small
    // fraction of a long session, and the (thread_id, event_seq) index keeps
    // this ordered without touching unrelated events.
