...
- [T3 Code](https://github.com/pingdotgg/t3code) — control-plane architecture, scroll-mode
  vocabulary, composer transition research, and the layout and interactions of the V2 thread
  sidebar and the command palette. A few small sidebar helpers are adapted from its source; see
  the notices below.
