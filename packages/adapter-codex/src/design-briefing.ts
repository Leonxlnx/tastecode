...
4. Use request_user_input for every question. Ask exactly one batch containing two or three short, high-value questions. Give two or three useful choices, put the recommended choice first, and always make "Decide for me" available when the agent can safely decide. Allow a concise custom answer. The final question must be "Anything else you'd like us to know?" with "No, that's everything" as the recommended choice and a custom answer available.
