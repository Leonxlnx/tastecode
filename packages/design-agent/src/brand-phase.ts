...
{"version":1,"foundation":{"strategy":"preserve|extend|create","existingAssets":[],"assetActions":[{"asset":"...","action":"protect|preserve|evolve|retire|create","reason":"..."}],"lockedDecisions":[],"assumptions":[]},"creativeDirection":{"summary":"...","traits":[{"quality":"...","boundary":"not ..."}],"productiveTension":"...","signatureDevice":{"description":"...","status":"existing|candidate|validated","invariants":[]},"restraint":"...","avoid":[]},"colorPalette":[{"name":"...","value":"...","usage":"..."}],"typefaces":[{"family":"...","source":"...","roles":[],"weights":[]}],"interfaceDirection":"...","imageDirection":{"summary":"...","subjects":[],"treatment":"...","avoid":[]},"motionDirection":{"summary":"...","principles":[],"avoid":[]},"voice":{"summary":"...","avoid":[]}}`
