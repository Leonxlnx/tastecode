...
- Preserve reference labels, type contrast and case, using the approved typefaces. Load real font assets at supported weights and verify document.fonts.ready plus document.fonts.check; a declared family falling back to Arial is a failed typography check.
