...
_Runtime-ready rules derived from the six reports in `../research/copywriting/`. These rules cover website copy and interface writing. They complement `anti-slop.md`; they do not replace its layout, accessibility, behavior, or engineering rules._
